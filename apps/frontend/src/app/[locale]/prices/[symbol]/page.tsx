            ...
            <div className="p-6 rounded-2xl border border-slate-900 bg-slate-950/60 backdrop-blur-xl shadow-2xl flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-3.5 text-xs">
                ...
                <div className="flex justify-between items-center py-1 border-b border-slate-900/40">
                  ...
                  <span className="font-bold text-slate-200">{ticker.cap}</span>
                </div>

                {/* Trailing P/E */}
                <div className="flex justify-between items-center py-1 border-b border-slate-900/40">
                  <span className="text-slate-500">P/E Ratio (Trailing)</span>
                ...
                {/* Average Volume */}
                <div className="flex justify-between items-center py-1 border-b border-slate-900/40">
                  <span className="text-slate-500">Avg. Volume (3M)</span>
                  <span className="font-bold text-slate-200">
                ...
                {/* 52 Week Range */}
                <div className="flex flex-col gap-1 py-1 border-b border-slate-900/40">
                ...
                {/* Dividend Rate */}
                <div className="flex justify-between items-center py-1 border-b border-slate-900/40">
                  <span className="text-slate-500">Dividend Rate</span>
                  <span className="font-bold text-slate-200">
